/**
 * String Rotation: Assume you have a method isSubstring which checks if _1one word is a substring
 * of another. Given _2two strings, s1 and s2, write code to check if s2 is a rotation of s1 using only _1one
 ...
 * - We are essentially asking if there's a way of splitting the first string into _2two parts, x and
