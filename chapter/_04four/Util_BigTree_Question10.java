...
public class Util_BigTree_Question10 {
    Util_BinTreeNode<Integer> bigRoot;
    Util_BinTreeNode<Integer> smallRoot;
    Util_BinTreeNode<Integer> irrelevantRoot;

    Util_BigTree_Question10() {
