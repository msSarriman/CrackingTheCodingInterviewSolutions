/**
 * Sum Lists: You have _2two numbers represented by a linked list, where each node contains a single
 * digit. The digits are stored in reverse order, such that the 1's digit is at the head of the list. Write a
 * function that adds the _2two numbers and returns the sum as a linked list.
 * EXAMPLE
 ...
 * number and back.
 * - Try recursion. Suppose you have _2two lists, A = 1- >5 - >9 (representing 951) and B
 ...
 * the head of _1one linked list might represent the 1000's place while the other represents
