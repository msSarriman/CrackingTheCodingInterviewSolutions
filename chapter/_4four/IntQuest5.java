...
public class IntQuest5 {
     ...
     * @return
     */
    public static boolean isBST(BinTreeNode node) {
        return isBST(node, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }
    private static boolean isBST(BinTreeNode node, Integer min, Integer max) {
    ...
    public static void main(String[] args) {
        ...
        root.add(1);        root.add(3);        root.add(5);        root.add(7);
        root.add(10);        root.add(12);        root.add(19);        root.add(21);
        BinTreeNode<Integer> injectedNode = new BinTreeNode<>(90);
